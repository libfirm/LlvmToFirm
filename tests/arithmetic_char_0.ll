...
entry:
  ...
  %d = alloca i8                                  ; <i8*> [#uses=3]
  %c = alloca i8                                  ; <i8*> [#uses=3]
  %b = alloca i8                                  ; <i8*> [#uses=8]
  %a = alloca i8                                  ; <i8*> [#uses=10]
  ...
  %20 = trunc i32 %19 to i8                       ; <i8> [#uses=1]
  %21 = load i8* %b, align 1                      ; <i8> [#uses=1]
  %22 = sub i8 %20, %21                           ; <i8> [#uses=1]
  ...
  %50 = load i8* %a, align 1                      ; <i8> [#uses=1]
  %51 = sext i8 %50 to i32                        ; <i32> [#uses=1]
  %52 = load i8* %b, align 1                      ; <i8> [#uses=1]
  %53 = sext i8 %52 to i32                        ; <i32> [#uses=1]
  %54 = sdiv i32 %51, %53                         ; <i32> [#uses=1]
  %55 = trunc i32 %54 to i8                       ; <i8> [#uses=1]
  %56 = sext i8 %55 to i32                        ; <i32> [#uses=1]
  ...
  %59 = sext i8 %58 to i32                        ; <i32> [#uses=1]
  %60 = load i8* %b, align 1                      ; <i8> [#uses=1]
  %61 = sext i8 %60 to i32                        ; <i32> [#uses=1]
  %62 = srem i32 %59, %61                         ; <i32> [#uses=1]
  %63 = trunc i32 %62 to i8                       ; <i8> [#uses=1]
  %64 = sext i8 %63 to i32                        ; <i32> [#uses=1]
  %65 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([23 x i8]* @.str8, i32 0, i32 0), i32 %64) nounwind ; <i32> [#uses=0]
  %66 = load i8* %c, align 1                      ; <i8> [#uses=1]
  %67 = load i8* %d, align 1                      ; <i8> [#uses=1]
  %68 = udiv i8 %66, %67                          ; <i8> [#uses=1]
  ...
  %71 = load i8* %c, align 1                      ; <i8> [#uses=1]
  %72 = load i8* %d, align 1                      ; <i8> [#uses=1]
  %73 = urem i8 %71, %72                          ; <i8> [#uses=1]
  %74 = zext i8 %73 to i32                        ; <i32> [#uses=1]
