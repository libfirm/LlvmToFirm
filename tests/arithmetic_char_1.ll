...
entry:
  ...
  %6 = trunc i32 %5 to i8                         ; <i8> [#uses=7]
  %7 = load i32* %y, align 4                      ; <i32> [#uses=1]
  %8 = trunc i32 %7 to i8                         ; <i8> [#uses=6]
  %9 = add i8 %8, %6                              ; <i8> [#uses=1]
  ...
  %12 = shl i8 %6, 1                              ; <i8> [#uses=1]
  %13 = sub i8 %12, %8                            ; <i8> [#uses=1]
  ...
  %16 = sext i8 %6 to i32                         ; <i32> [#uses=3]
  %17 = mul i32 %16, 3                            ; <i32> [#uses=1]
  %18 = sext i8 %8 to i32                         ; <i32> [#uses=2]
  ...
  %24 = shl i8 %6, 2                              ; <i8> [#uses=1]
  %25 = mul i8 %24, %6                            ; <i8> [#uses=1]
  %26 = sub i8 %25, %8                            ; <i8> [#uses=1]
  ...
  %30 = trunc i32 %19 to i8                       ; <i8> [#uses=1]
